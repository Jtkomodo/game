...
public class AABB {
	...
	private Vector2f position,lc=new Vector2f(0,0),rc=new Vector2f(0,0),r,Pposition=new Vector2f(0,0);
   ...
   public Vector2f findVector(Vector2f position, Vector2f movement,Vector2f direction,AABB box) {
	   ...
	   position.sub(this.r,lc);//this is the bottom left corner of the cuurent box
	   position.add(this.r,rc); //this is the top right corner
	   ...
	   if(amount!=0 && amount!=1) {     
		...
		Vector2f d= new Vector2f(0,0);currentmovement.sub(box.position,d);
	    Vector2f closest;
